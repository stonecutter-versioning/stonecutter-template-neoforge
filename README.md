...
6. Review `src/main/resources/META-INF/neoforge.mods.toml` to have up-to-date properties.
...
- [Neoforge Discord server](https://discord.neoforged.net/): for mod development help.
